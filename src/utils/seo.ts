...
export function buildTitle(pageTitle: string, siteName: string = 'Generación Urbana'): string {
...
export function buildCanonical(path: string, baseUrl: string = 'https://generacionurbana.cl'): string {
...
export function generateMetaRobots(noindex: boolean = false, nofollow: boolean = false): string {
  const robots = [];
